...
# from ..app import HydroshareGisDataViewer
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.hydroshare_gis_data_viewer"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.hydroshare_gis_data_viewer.tests.tests"

        To run tests in the HydroshareGisDataViewerTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.hydroshare_gis_data_viewer.tests.tests.HydroshareGisDataViewerTestCase"

        To run only the test_if_tethys_platform_is_great function in the HydroshareGisDataViewerTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.hydroshare_gis_data_viewer.tests.tests.HydroshareGisDataViewerTestCase.test_if_tethys_platform_is_great"
...
class HydroshareDataViewerTestCase(TethysTestCase):
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(HydroshareGisDataViewer)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(HydroshareGisDataViewer)
